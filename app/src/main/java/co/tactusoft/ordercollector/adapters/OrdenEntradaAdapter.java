...
public class OrdenEntradaAdapter extends ArrayAdapter<OrdenesEntradas> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.frlItem  = (FrameLayout) convertView.findViewById(R.id.frl_item_oe);
        ...
        if (item != null) {
            ...
            holder.textView2.setText(item.getEstadoOrden());
            holder.textView3.setText(item.getNumeroDocumentoOrdenCliente() );
            holder.textView4.setText(item.getFechaPlaneadaEntregaMaxima());
